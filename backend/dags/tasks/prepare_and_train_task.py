...
def prepare_and_train_task(extract_result, validation_summary):
    ...
    run_id = mlflow_manager.start_run(run_name="sales_forecasting_training")
    ...
    try:
        ...
        # The ModelTrainer is now expected to handle logging of models, params, and metrics
        # using the provided mlflow_manager.
        results = trainer.train_all_models(
            train_df, val_df, test_df, target_col="sales", use_optuna=True, mlflow_manager=mlflow_manager
        )
